  ...
  try {
    if (!(element.parentElement.classList.contains("DoNotWatch"))) {
      ...
      newDiv.appendChild(element);
        ...
        warningText.setAttribute("style", "position: absolute; z-index: 999; flex: 0 0 120px; color: white; font-size: 35px; -webkit-text-stroke-width: 1px; -webkit-text-stroke-color: black;");
      ...
      newDiv.onclick = function() {
        console.log("miep");
          ...
          element.parentElement.getElementsByClassName("textToDelete")[0].remove()
      }
    }
  } catch (e) {} finally {}
};
